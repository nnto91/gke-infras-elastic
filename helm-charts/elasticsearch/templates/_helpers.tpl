...
{{- else -}}
{{- $altNames := list ( .Values.domain ) ( include "elasticsearch.masterService" . ) ( printf "%s.%s" (include "elasticsearch.masterService" .) .Release.Namespace ) ( printf "%s.%s.svc" (include "elasticsearch.masterService" .) .Release.Namespace ) -}}
{{- $ca := genCA "elasticsearch-ca" 3650 -}}
{{- $cert := genSignedCert ( include "elasticsearch.masterService" . ) nil $altNames 3650 $ca -}}
